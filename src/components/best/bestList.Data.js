const bestListItems = [
  { id: 1, src: `${process.env.PUBLIC_URL}/images/best01.svg`, new: 'NEW', best: 'BEST', title: '보로실리케이트 글라스 프렌치프레스', price: '45,000' },
  { id: 2, src: `${process.env.PUBLIC_URL}/images/best02.svg`, best: 'BEST', title: '블록 프린트 러그', price: '359,000' },
